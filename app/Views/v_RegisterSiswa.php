        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <!-- left column -->
                    <div class="col-md-12">
                        <?php echo form_open_multipart('RegisterSiswa/simpanPendaftaran') ?>
                        <!-- jquery validation -->
                            ...
                            <form id="quickForm">
                                <div class="card-body">
                                    <div class="form-group">
                                        <label>Nama</label>
                                        <input name="nama" value="<?= old('nama') ?>" class="form-control" placeholder="Nama">
                                        <p class="text-danger"><?= $validation->hasError('nama') ? $validation->getError('nama') : '' ?></p>
                                    </div>
                                    <div class="form-group">
                                        <label>Tanggal Lahir</label>
                                        <input name="tgl_lahir" value="<?= old('tgl_lahir') ?>" class="form-control" placeholder="Tanggal Lahir">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="no_telp" value="<?= old('no_telp') ?>" class="form-control" placeholder="Nomor Telpon">
                                        <p class="text-danger"><?= $validation->hasError('no_telp') ? $validation->getError('no_telp') : '' ?></p>
                                    </div>
                                    <div class="form-group">
                                        <label>Jenis Kelamin</label>
                                        <input name="jk" value="<?= old('jk') ?>" class="form-control" placeholder="Jenis Kelamin">
